...
**Актуальная версия: `0.1.25`** · id `coin-rebalancer.element-picker`
...
1. Скачайте `element-picker-0.1.25.vsix` из [Releases](https://github.com/Ydjin1984/DaVinci_element_picker/releases) или возьмите файл после локальной сборки.
...
Ожидается: `coin-rebalancer.element-picker@0.1.25`
...
(`v0.1.25 · ui|workspace · platform`) — удобно понять, на каком хосте крутится расширение.
