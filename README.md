...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.1.29-4fc3f7" alt="version 0.1.29" />
...
**Current release: `0.1.29`** · package id `coin-rebalancer.element-picker`

### From VSIX (recommended)

1. Download **`element-picker-0.1.29.vsix`** from [Releases](https://github.com/Ydjin1984/DaVinci_element_picker/releases) or build locally.
...
(`v0.1.29 · ui · platform`) so Local UI host is obvious (must be `ui`, not `workspace`).
...
- Package: `npm run package` → `element-picker-0.1.29.vsix`  
