...
**Current version: `0.1.27`** · id `coin-rebalancer.element-picker`
...
1. Download `element-picker-0.1.27.vsix` from [Releases](https://github.com/Ydjin1984/DaVinci_element_picker/releases) or the repo root / `dist/` after a local build.
...
Expected: `coin-rebalancer.element-picker@0.1.27`
